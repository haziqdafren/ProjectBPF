...
@section('content')
    ...
    <div class="container">
        <!-- Form pencarian -->
        <form action="{{ route('histori.index') }}" method="GET">
            <div class="input-group mb-3">
                <!-- Mengatur ukuran input agar lebih kecil dan tombol juga lebih kecil -->
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <p class="text-xs font-weight-bold mb-0">
                                                    {{ \Carbon\Carbon::parse($history->tgl_tiba)->format('d/m/Y') }}</p>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('data-paket.edit', $history->no_resi) }}"
