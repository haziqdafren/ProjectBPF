                                ...
                                <div class="card card-plain mt-4">
                                    ...
                                    <div class="card-header pb-0 text-left bg-transparent">
                                        <div class="mb-4"> <!-- Added a margin bottom for spacing -->
                                            ...
                                            <p class="mb-0">Masukkan nomor resi atau detail terkait untuk mencari data
                                                paket Anda.</p>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <form role="form" method="GET" action="{{ url('search-paket') }}">
                                            ...
                                            <div class="mb-3">
                                                <input type="text" name="resi" class="form-control"
                                                    placeholder="Masukkan nomor resi" aria-label="Nomor Resi"
                                                    aria-describedby="resi-addon">
                                            </div>
                                            <div class="text-center">
                                                <button type="submit" class="btn bg-gradient-info w-100 mt-4 mb-0">Cari
                                                    Paket</button>
                                            </div>
                                        </form>
                                    </div>
