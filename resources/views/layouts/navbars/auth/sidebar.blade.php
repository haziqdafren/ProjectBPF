...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap justify-content-center" href="{{ route('dashboard') }}">
        <img src="../assets/img/logos/logo.png" class="navbar-brand-img logo-large" alt="...">
        {{-- <span class="ms-3 font-weight-bold">Surpa</span> --}}
    </a>
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('user-management') ? 'active' : '') }}" href="{{ url('user-management') }}">
            ...
            <span class="nav-link-text ms-1">Histori Paket</span>
        </a>
      </li>
      <li class="nav-item mt-2">
